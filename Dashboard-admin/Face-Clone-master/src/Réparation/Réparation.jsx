...
import TabR from './TabRéparation/TabR'
...
function Boutiques() {
  return (
    <div>
        ...
        <div id='d1'><BleftRow Icon={BuildCircleIcon} name="Entreprises de réparation" href="/Réparation" /></div>
    ...
    <a href='/AddR'><button className='btn1'> Ajouter une entreprise de réparation </button></a>
    </div>
